...
$(function() {
$( 'body' ).append("<div id='ServiceCaseGadget' data-pega-gadgetname ='ServiceCaseGadget' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='PegaCS-IVA-WCB-Sample' data-pega-isdeferloaded ='true' data-pega-threadname ='CSServiceCase' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='onServiceCaseClose' data-pega-url ='https://127.0.0.1/prweb/PRChat' data-pega-action-param-parameters =''></div>");
$( 'body' ).append("<div id='OnlineHelp' data-pega-gadgetname ='OnlineHelp' data-pega-action ='createNewWork' data-pega-action-param-classname ='' data-pega-action-param-flowname ='' data-pega-action-param-model ='' data-pega-applicationname ='PegaCS-IVA-WCB-Sample' data-pega-isdeferloaded ='true' data-pega-threadname ='CSAdvisor' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-url ='https://127.0.0.1/prweb/PRChat' data-pega-action-param-parameters ='' data-pega-redirectguests='true' data-pega-event-onclose ='hideinline'></div>");
...
$( 'body' ).append("<div style='display:none; height:80px; padding-top:14px; padding-left:20px;' id='Preview' data-pega-gadgetname ='PreviewGadget' data-pega-isdeferloaded ='true' data-pega-action ='display' data-pega-action-param-classname ='PegaCS-OnlineHelp-Triage-WebChatbot'  data-pega-harnessname ='Preview' data-pega-applicationname ='PegaCS-IVA-WCB-Sample' data-pega-threadname ='Preview' data-pega-systemid ='pega' data-pega-resizetype ='fixed' data-pega-event-onclose ='' data-pega-url ='https://127.0.0.1/prweb/PRChat' data-pega-action-param-parameters=''></div>");
});
/***********************************************************************************************************************
